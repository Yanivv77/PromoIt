...
namespace User
{
    ...
    public partial class UserClient 
    {
        ...
        internal Task SendAsync(UserClient userClient, CancellationToken token)
        {
        ...
        public System.Threading.Tasks.Task SendAsync(User body)
        {
        ...
        /// <returns>Operation succeeded</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task SendAsync(User body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/UserLogin");
